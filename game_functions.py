...
def get_number_rows(ai_settings, ship_height, alien_height):
	#determint the number of rows  of aliens that fit on the screen
...
def create_fleet(ai_settings, screen, ship, aliens):
	#create alien and find no of aliens in arow
...
def update_screen(ai_settings, stats, sb, screen, ship, aliens, bullets, play_button):
	#update images on screen and flip screen
